        ...
        if req.action == "run":
            ...
            cmd = {
                ...
                "js": f"eslint \"{abs_path}\"",
                  ...
                  f"echo 'Linter not configured for {req.language}'")
            ...
            cmd = {
                ...
                "js": f"npm test {abs_path}",
                  ...
                  f"echo 'Testing not configured for {req.language}'")
            ...
            cmd = {
                ...
                "js": f"prettier --write \"{abs_path}\"",
                  ...
                  f"echo 'Formatter not configured for {req.language}'")
            ...
            cmd = {
                ...
                "js": f"eslint \"{abs_path}\" --fix",
                  ...
                  f"echo 'Fixer not configured for {req.language}'")

        elif req.action == "explain":
            with open(abs_path, 'r', encoding='utf-8') as f:
                return {
                    "code": f.read(),
                    "explanation": "[GPT should explain this]"
                }
